...
sender_address = web3.toChecksumAddress('ENTER address you want to use to snipe token')

#Token to buy 
tokenA = web3.toChecksumAddress('0x20e7256Db0e517E387b494457e4Df67A624f1968')  #TokenAddress of token to snipe
...
def buy():
    ...
    'from': sender_address,
    'value': web3.toWei(0.01,'ether'),#This is the Token(BNB) amount you want to Swap from  | Comment out for token
    'gas':210000,
    'gasPrice': web3.toWei('5','gwei'),
    'nonce': nonce,
    })
    #Sign transaction with priavte key here
    signed_txn = web3.eth.account.sign_transaction(pancakeswap2_txn, private_key='ENTER YOUR PRIVATEKEY')
